...
def ring_flash_attn_forward(
    ...
    if joint_strategy not in supported_joint_strategy:
        ...
        raise ValueError(
            "joint_tensor_key & joint_tensor_value must not be None when joint_strategy is not None"
        )
...
class hetuDiTRingFlashAttnFunc(RingFlashAttnFunc):
    @staticmethod
    def forward(
        ctx,
        q,
...
def ring_flash_attn_func(
    ...
    return hetuDiTRingFlashAttnFunc.apply(
        q,
        k,
        v,
        dropout_p,
