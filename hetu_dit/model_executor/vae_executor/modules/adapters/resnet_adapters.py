...
from hetu_dit.model_executor.vae_executor.models.resnet import PatchResnetBlock2D
    ...
    def __init__(
        ...
        *,
        ...
        assert resnet.time_emb_proj is None, (
            "temb_channels is not supported in ResnetBlock2DAdapter currently"
        )
        assert resnet.up is False, (
            "up sample is not supported in ResnetBlock2DAdapter currently"
        )
        assert resnet.down is False, (
            "ResnetBlock2DAdapter dose not support down sample is not supported in  currently"
        )
        ...
        self.resnet.conv_shortcut = (
            Conv2dAdapter(resnet.conv_shortcut, block_size=conv_block_size)
