...
from hetu_dit.model_executor.pipelines import hetuDiTPipelineBaseWrapper
...
@hetuDiTPipelineWrapperRegister.register(HunyuanDiTPipeline)
class hetuDiTHunyuanDiTPipeline(hetuDiTPipelineBaseWrapper):
    def __init__(
        self,
    ...
    def encode_stage(
        ...
        **kwargs,
        ...
        prompt_attention_mask_2 = prompt_attention_mask_2.to("cpu")
