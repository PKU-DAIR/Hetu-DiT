...
class hetuDiTDiffusionModelBaseWrapper(
    nn.Module, hetuDiTDiffusionBaseWrapper, metaclass=ABCMeta
):
    wrapped_layers: List[hetuDiTDiffusionLayerBaseWrapper]
    ...
    def _register_cache(
        ...
        for layer in self.wrapped_layers:
            if isinstance(layer, hetuDiTAttentionWrapper):
