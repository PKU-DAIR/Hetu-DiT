...
from hetu_dit.core.distributed import is_pipeline_first_stage, is_pipeline_last_stage
...
@hetuDiTTransformerWrappersRegister.register(SD3Transformer2DModel)
class hetuDiTSD3Transformer2DWrapper(hetuDiTDiffusionTransformerBaseWrapper):
    def __init__(
        self,
