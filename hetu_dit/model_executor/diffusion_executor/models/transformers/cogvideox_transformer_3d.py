...
@hetuDiTTransformerWrappersRegister.register(CogVideoXTransformer3DModel)
class hetuDiTCogVideoXTransformer3DWrapper(hetuDiTDiffusionTransformerBaseWrapper):
    def __init__(
        self,
    ...
    @hetuDiTBaseWrapper.forward_check_condition
    def forward(
        self,
