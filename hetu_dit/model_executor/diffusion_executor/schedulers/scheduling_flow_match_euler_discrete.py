...
from hetu_dit.core.distributed import get_runtime_state
...
@hetuDiTSchedulerWrappersRegister.register(FlowMatchEulerDiscreteScheduler)
class hetuDiTFlowMatchEulerDiscreteSchedulerWrapper(hetuDiTSchedulerBaseWrapper):
