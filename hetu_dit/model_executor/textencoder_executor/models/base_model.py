...
from hetu_dit.model_executor.textencoder_executor.layers import *
from hetu_dit.model_executor.textencoder_executor.base_textencoder_warpper import (
    hetuDiTTextEncoderBaseWrapper,
)
from hetu_dit.core.distributed import get_world_group
...
class hetuDiTTextEncoderModelBaseWrapper(
    nn.Module, hetuDiTTextEncoderBaseWrapper, metaclass=ABCMeta
):
    wrapped_layers: List[hetuDiTTextEncoderLayerBaseWrapper]
    ...
    def _wrap_layers(
        ...
        for name, module in model.named_modules():
            if isinstance(module, hetuDiTTextEncoderLayerBaseWrapper):
                continue
