...
if TYPE_CHECKING:
    ...
    HETUDIT_LOGGING_LEVEL: str = "INFO"
    CUDA_VERSION: version.Version
    TORCH_VERSION: version.Version

# ================== Environment Variables ==================
# Setting environment variables directly in the code
os.environ["RAY_DEDUP_LOGS"] = "0"
os.environ["NCCL_DEBUG"] = "WARN"
os.environ["NCCL_ASYNC_ERROR_HANDLING"] = "1"  # NCCL asynchronous errors
...
environment_variables: Dict[str, Callable[[], Any]] = {
    ...
    "HETUDIT_LOGGING_LEVEL": lambda: os.getenv("HETUDIT_LOGGING_LEVEL", "WARNING"),
}
